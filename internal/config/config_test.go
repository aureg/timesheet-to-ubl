...
func TestResolve(t *testing.T) {
	...
	if res.DailyRate != 150.0 {
		t.Errorf("Expected 150.0, got %f", res.DailyRate)
	}
	...
	if res2.DailyRate != 100.0 {
		t.Errorf("Expected default 100.0, got %f", res2.DailyRate)
	}
	...
	if res3.DailyRate != 120.0 {
		t.Errorf("Expected project rate 120.0, got %f", res3.DailyRate)
	}
